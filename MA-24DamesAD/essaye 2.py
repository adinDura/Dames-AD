...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN and pion_selectionne is not None:
         if event.key == pygame.K_w:  # Haut-gauche
            deplacer_pion(pion_selectionne, "UP_LEFT")
         elif event.key == pygame.K_e:  # Haut-droite
            deplacer_pion(pion_selectionne, "UP_RIGHT")
        elif event.key == pygame.K_a:  # Bas-gauche
            deplacer_pion(pion_selectionne, "DOWN_LEFT")
        elif event.key == pygame.K_d:  # Bas-droite
            deplacer_pion(pion_selectionne, "DOWN_RIGHT")
